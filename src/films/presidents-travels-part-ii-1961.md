...
top_billed_cast:
  ...
  - name: Katô Daisuke
    role: Kuramochi Zensuke
  - name: Kobayashi Keiju
    role: Kuwabara Takeshi
  - name: Dan Reiko
    role: Matsuura Keiko
  - name: Nakajima Sonomi
    role: Takahashi Momoko
  - name: Hama Mie
    role: Misawa Sachiko
  - name: Awaji Keiko
    role: Madame Emiko
  - name: Kusabue Mitsuko
    role: Geisha Shimemaru
  - name: Miki Norihei
    role: Branch Manager Doi
  - name: Tachikawa Hiroshi
    role: Nakamura
  - name: Kuji Asami
    role: Misawa Fukuko
  - name: Sazanka Kyû
    role: President Oyamada
  - name: Fujiwara Kamatari
    role: Unagiya Kondô
  - name: Tazaki Jun
    role: President Kondô
---
